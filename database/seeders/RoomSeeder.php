...
class RoomSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rooms = [
            ...
            ['room_number' => '105', 'floor' => 1, 'room_type_id' => $standard, 'status' => 'maintenance'],
            ...
            ['room_number' => '205', 'floor' => 2, 'room_type_id' => $deluxe, 'status' => 'available'],
            ...
            ['room_number' => '305', 'floor' => 3, 'room_type_id' => $suite, 'status' => 'available'],
        ];
