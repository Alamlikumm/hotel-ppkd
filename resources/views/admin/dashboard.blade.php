...
@section('subtitle', 'Todays Hotel Operational Summary')
...
<div class="grid grid-cols-2 gap-5 mb-5">
    ...
    <div class="bg-white dark:bg-white/4 border border-gray-100 dark:border-white/8 rounded-2xl overflow-hidden">
        ...
        <div class="divide-y divide-gray-50 dark:divide-white/5">
            ...
            @empty
            <p class="px-5 py-6 text-center text-sm text-gray-400 dark:text-white/25">There Are No Bookings Yet</p>
            @endforelse
        </div>
    </div>
        ...
        <div class="divide-y divide-gray-50 dark:divide-white/5">
            ...
            <div class="flex items-center justify-between px-5 py-3">
                <div>
                    ...
                    <p class="text-xs text-gray-400 dark:text-white/30 mt-0.5">
                        Room {{ $order->room_number ?? '-' }} · Rp {{ number_format($order->total_price, 0, ',', '.') }}
                    </p>
                </div>
                @php
                $fnbMap = [
            ...
            @empty
            <p class="px-5 py-6 text-center text-sm text-gray-400 dark:text-white/25">No Orders Yet</p>
            @endforelse
        </div>
    </div>
</div>
