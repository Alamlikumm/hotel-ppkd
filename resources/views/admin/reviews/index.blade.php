...
<div class="grid grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white dark:bg-white/4 border border-gray-100 dark:border-white/8 rounded-2xl p-5">
        <p class="text-xs text-gray-400 dark:text-white/30 mb-2">Average Rating</p>
        <p class="text-3xl font-bold text-amber-500">{{ $avgRating }} ⭐</p>
    </div>
    <div class="bg-white dark:bg-white/4 border border-gray-100 dark:border-white/8 rounded-2xl p-5">
        <p class="text-xs text-gray-400 dark:text-white/30 mb-2">Total Reviews</p>
        <p class="text-3xl font-bold text-gray-800 dark:text-white">{{ $total }}</p>
    </div>
    <div class="bg-white dark:bg-white/4 border border-gray-100 dark:border-white/8 rounded-2xl p-5">
        <p class="text-xs text-gray-400 dark:text-white/30 mb-2">5 stars</p>
        <p class="text-3xl font-bold text-green-500">{{ $five }}</p>
    </div>
    <div class="bg-white dark:bg-white/4 border border-gray-100 dark:border-white/8 rounded-2xl p-5">
        <p class="text-xs text-gray-400 dark:text-white/30 mb-2">Need Response</p>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 dark:text-white/30">
                        ...
                        @if($review->booking)· Room {{ $review->booking->room->room_number }}@endif
                    </p>
                </div>
            </div>
