        ...
        <div>
            <div class="fade-up-2">
                ...
                <h1 class="text-5xl font-bold leading-tight mb-6">
                    <span class="shimmer-text">Manage Hotels                    </span>
                    <br>
                    <span class="text-white">Easily</span>
                    <br>
                    <span class="text-white/40">&amp; Efficient</span>
                </h1>
            </div>
            <div class="fade-up-3">
                <p class="text-white/40 text-base leading-relaxed max-w-md">
                    An integrated Administration Platform For Managing Rooms, Reservations, F&B, and reports In One Modern Dashboard.
                </p>
            </div>
            <div class="fade-up-4 flex items-center gap-6 mt-10">
                <div class="text-center">
                    <div class="text-2xl font-bold text-white">48+</div>
                    <div class="text-xs text-white/40 mt-1">Room</div>
                </div>
                <div class="w-px h-10 bg-white/10"></div>
                <div class="text-center">
                    <div class="text-2xl font-bold text-white">3</div>
                    <div class="text-xs text-white/40 mt-1">Rooms Type</div>
                </div>
                <div class="w-px h-10 bg-white/10"></div>
                <div class="text-center">
                    <div class="text-2xl font-bold text-white">24/7</div>
                    <div class="text-xs text-white/40 mt-1">Operational</div>
                </div>
            </div>
        </div>
                            ...
                            <label class="flex items-center gap-2.5 cursor-pointer group">
                                <div class="relative">
                                    ...
                                    <div class="w-4 h-4 rounded border border-white/20 bg-white/5
                                                peer-checked:bg-black-600 peer-checked:border-black-600
